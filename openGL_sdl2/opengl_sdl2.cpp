...
int main(int argc, char* argv[])
{
    ...
    // Before creating a window, specify OpenGL version
    ...
    640,
    480,
    SDL_WINDOW_SHOWN | SDL_WINDOW_OPENGL);      // SDL_WINDOW_SHOWN is ignored by SDL_CreateWindow
    ...
    // this will enable us to load functions like glClearColor()
